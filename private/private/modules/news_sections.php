...
$config = require_once ROOT . '/config/modules/news_sections.php';
...
elseif (isset($_GET['delete'])) :
    ...
    $obj = NewsSections::findById($_GET['delete']);
    ...
    $perPage = $_SESSION['newssections']['per_page'] ?? $config['pagination']['default_per_page'];
    $order_by = $config['pagination']['order_by'] ?? 'ORDER BY rate DESC, id DESC';

    // Вызов пагинации
    $result = Pagination::create(
        modelClass: NewsSections::class,
        where: $where,
        order: $order_by,
