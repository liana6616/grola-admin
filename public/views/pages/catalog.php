...
<main>
  <div class="catalog">
            ...
            <? foreach($this->categories AS $item): ?>
                <? if($item->parent == 0): ?>
                    <li class="catalog__item">
                        <a href="<?= $item->url ?>">
                            <h3><?= $item->name ?></h3>
                            <span class="catalog__text">12 345 товара</span>
                        </a>
                    </li>
                <? endif; ?>
            <? endforeach; ?>
    ...
    <!-- <ul class="catalog__list">
      <li class="catalog__item">
        <a href="#">
          <h3 class="catalog__small">Двери</h3>
          <span class="catalog__text">12 345 товара</span>
        </a>
      </li>
      <li class="catalog__item">
        <a href="#">
          <h3 class="catalog__small">Шкафы металлические</h3>
          <span class="catalog__text">23 440 товара</span>
        </a>
      </li>
      <li class="catalog__item">
        <a href="/catalog-category.php">
          <h3 class="catalog__small">Для склада</h3>
          <span class="catalog__text">2 309 товара</span>
        </a>
      </li>
      <li class="catalog__item">
        <a href="#">
          <h3 class="catalog__small">Для производства</h3>
          <span class="catalog__text">789 товара</span>
        </a>
      </li>
      <li class="catalog__item">
        <a href="#">
          <h3 class="catalog__small">Индивидуальные проекты из металла</h3>
          <span class="catalog__text">4 378 товара</span>
        </a>
      </li>
    </ul> -->
    ...
    <div class="catalog__wrapper-filter">
        ...
        <div class="catalog__filter-hidden">
            <div class="catalog__filter-wrapper-sort">
                ...
                <button class="catalog__button-filter catalog__button-filter--sorting active filter" onclick="this.classList.toggle('active')" type="button" ><span>По пулярности</span></button>
                <button class="catalog__button-filter catalog__button-filter--sum filter" onclick="this.classList.toggle('active')" type="button" ><span>По цене</span></button>
            </div>
            <div class="catalog__filter-wrapper-block">
                <div class="catalog__filter-wrapper-sum">
                    ...
                    <div class="catalog__filter-polzunok">
                        <div class="catalog__filter-weight"></div>
                    </div>
                </div>
    ...
    <div class="catalog__list-wrapper">
        ...
        <!-- <ul class="catalog-card__list">
            ...
            <li class="catalog-card__item">
                ...
                <h3 class="catalog-card__title title-small">Контейнер КГ-04</h3>
                <div class="catalog-card__wrapper-parameters">
                    <span class="catalog-card__name">Габаритные размеры:</span>
            ...
            <li class="catalog-card__item">
                <div class="catalog-card__wrapper-img">
                    <img class="catalog-card__img" src="/public/images/catalog/card-4.png">
                </div>

                <h3 class="catalog-card__title title-small">Металлические</h3>
                <div class="catalog-card__wrapper-parameters">
                    <span class="catalog-card__name">Габаритные размеры:</span>
            ...
            <li class="catalog-card__item">
                <span class="catalog-card__cta catalog-card__cta-hit">Хит</span>
                <div class="catalog-card__wrapper-img">
                    <img class="catalog-card__img" src="/public/images/catalog/card-8.png">
                </div>
            ...
            <li class="catalog-card__item">
                <span class="catalog-card__cta catalog-card__cta-action">Акция</span>
                <div class="catalog-card__wrapper-img">
                    <img class="catalog-card__img" src="/public/images/catalog/card-6.png">
                </div>
