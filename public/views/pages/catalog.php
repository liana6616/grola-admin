  ...
  <div class="catalog">
    ...
    <div class="catalog__wrapper-filter">
        ...
        <div class="catalog__filter-hidden">
            ...
            <div data-sort="rate" data-order="<?= $rate_order ?>" 
                class="catalog__button-filter catalog__button-filter--sorting filter js-filter 
                <?= $is_rate ? 'active' : '' ?>
                <?= $rate_order == 'DESC' ? 'active-order' : '' ?>
                ">
                <span>По популярности</span>

            </div>
                
            <div  data-sort="price" data-order="<?= $price_order ?>"
            class="catalog__button-filter catalog__button-filter--sum filter js-filter 
                <?= $is_price ? 'active' : '' ?>
                <?= $price_order == 'DESC' ? 'active-order' : '' ?>
                ">
                <span>По цене</span>
        ...
        <form id="filter-form" style="display: none;">
            <input type="hidden" name="subcat" value="<?= $this->selectedSubcat ?>">
            <input type="hidden" name="sort" value="<?= $this->current_sort ?>">
            <input type="hidden" name="order" value="<?= $this->current_order ?>">
            <input type="hidden" name="price_min" value="<?= $current_min ?>">
            <input type="hidden" name="price_max" value="<?= $current_max ?>">
        </form>
